...
module.exports = {
	...
	execute(message, args) {
		const embed = new EmbedBuilder()
			...
			.setDescription(
				`Check out our [Nexus Mods page](https://www.nexusmods.com/pokemonbdsp/mods/1) to download our mod!\n\n**You must provide your own dump of Brilliant Diamond or Shining Pearl 1.3.0** from a hacked Switch to work with Luminescent Platinum; asking anybody to provide download links is piracy and an instant ban.`,
			)
			.setColor(0xadd8e6);
