...
module.exports = {
	...
	execute(message, args) {
		const embed = new EmbedBuilder()
			...
			.setThumbnail(
				"https://cdn.discordapp.com/attachments/917239249747738624/1167491975231066183/image.png?ex=654e52a1&is=653bdda1&hm=8043bff359b11850c02bf8bd5ada206ef9bafe326f33ceac948ad7d0738d5a87&",
			)
			.setColor("#00b0f4");
