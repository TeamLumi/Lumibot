...
module.exports = {
	...
	execute(message, args) {
		...
		if (message.content.toLowerCase().includes("[encounters]")) {
			...
			embed.setTitle("Static Encounters")
			...
			embed.setTitle("Traded Pokémon")
			.setURL("https://luminescent.team/docs/special-events/trade")
			.setDescription(
			"All available trades in the game."
			);
			...
			embed.setTitle("Legendary Encounters")
